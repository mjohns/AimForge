...
namespace aim {
class BundleFileLocation;
struct BundleFileLocationDefaultTypeInternal;
extern BundleFileLocationDefaultTypeInternal _BundleFileLocation_default_instance_;
extern const ::google::protobuf::internal::ClassDataFull BundleFileLocation_class_data_;
class BundleInfo;
...
class BundleFileLocation final : public ::google::protobuf::Message
/* @@protoc_insertion_point(class_definition:aim.BundleFileLocation) */ {
 public:
  inline BundleFileLocation() : BundleFileLocation(nullptr) {}
  ~BundleFileLocation() PROTOBUF_FINAL;

#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(BundleFileLocation* PROTOBUF_NONNULL msg, ::std::destroying_delete_t) {
    SharedDtor(*msg);
    ::google::protobuf::internal::SizedDelete(msg, sizeof(BundleFileLocation));
  }
#endif

  template <typename = void>
  explicit PROTOBUF_CONSTEXPR BundleFileLocation(::google::protobuf::internal::ConstantInitialized);

  inline BundleFileLocation(const BundleFileLocation& from) : BundleFileLocation(nullptr, from) {}
  inline BundleFileLocation(BundleFileLocation&& from) noexcept
      : BundleFileLocation(nullptr, ::std::move(from)) {}
  inline BundleFileLocation& operator=(const BundleFileLocation& from) {
    CopyFrom(from);
    return *this;
  }
  inline BundleFileLocation& operator=(BundleFileLocation&& from) noexcept {
    if (this == &from) return *this;
    if (::google::protobuf::internal::CanMoveWithInternalSwap(GetArena(), from.GetArena())) {
      InternalSwap(&from);
    } else {
  ...
  static const BundleFileLocation& default_instance() {
    return *reinterpret_cast<const BundleFileLocation*>(
        &_BundleFileLocation_default_instance_);
  }
  enum TypeCase {
    kBinaryDir = 1,
    kUserDir = 2,
  ...
  friend void swap(BundleFileLocation& a, BundleFileLocation& b) { a.Swap(&b); }
  inline void Swap(BundleFileLocation* PROTOBUF_NONNULL other) {
    if (other == this) return;
    if (::google::protobuf::internal::CanUseInternalSwap(GetArena(), other->GetArena())) {
      InternalSwap(other);
    } else {
  ...
  void UnsafeArenaSwap(BundleFileLocation* PROTOBUF_NONNULL other) {
    if (other == this) return;
    ABSL_DCHECK(GetArena() == other->GetArena());
    InternalSwap(other);
  }
  ...
  BundleFileLocation* PROTOBUF_NONNULL New(::google::protobuf::Arena* PROTOBUF_NULLABLE arena = nullptr) const {
    return ::google::protobuf::Message::DefaultConstruct<BundleFileLocation>(arena);
  }
  using ::google::protobuf::Message::CopyFrom;
  void CopyFrom(const BundleFileLocation& from);
  using ::google::protobuf::Message::MergeFrom;
  void MergeFrom(const BundleFileLocation& from) { BundleFileLocation::MergeImpl(*this, from); }
  ...
  void SharedCtor(::google::protobuf::Arena* PROTOBUF_NULLABLE arena);
  static void SharedDtor(MessageLite& self);
  void InternalSwap(BundleFileLocation* PROTOBUF_NONNULL other);
 private:
  template <typename T>
  friend ::absl::string_view(::google::protobuf::internal::GetAnyMessageName)();
  static ::absl::string_view FullMessageName() { return "aim.BundleFileLocation"; }

  explicit BundleFileLocation(::google::protobuf::Arena* PROTOBUF_NULLABLE arena);
  BundleFileLocation(::google::protobuf::Arena* PROTOBUF_NULLABLE arena, const BundleFileLocation& from);
  BundleFileLocation(
      ::google::protobuf::Arena* PROTOBUF_NULLABLE arena, BundleFileLocation&& from) noexcept
      : BundleFileLocation(arena) {
    *this = ::std::move(from);
  }
  const ::google::protobuf::internal::ClassData* PROTOBUF_NONNULL GetClassData() const PROTOBUF_FINAL;
  static void* PROTOBUF_NONNULL PlacementNew_(
 ...
 public:
  ...
  // accessors -------------------------------------------------------
  enum : int {
    kBinaryDirFieldNumber = 1,
    kUserDirFieldNumber = 2,
    kExplicitPathFieldNumber = 3,
  };
  // bool binary_dir = 1;
  bool has_binary_dir() const;
  void clear_binary_dir() ;
  bool binary_dir() const;
  void set_binary_dir(bool value);

  private:
  bool _internal_binary_dir() const;
  void _internal_set_binary_dir(bool value);

  public:
  // bool user_dir = 2;
  bool has_user_dir() const;
  void clear_user_dir() ;
  bool user_dir() const;
  void set_user_dir(bool value);

  private:
  bool _internal_user_dir() const;
  void _internal_set_user_dir(bool value);

  public:
  // string explicit_path = 3;
  bool has_explicit_path() const;
  void clear_explicit_path() ;
  const ::std::string& explicit_path() const;
  template <typename Arg_ = const ::std::string&, typename... Args_>
  void set_explicit_path(Arg_&& arg, Args_... args);
  ::std::string* PROTOBUF_NONNULL mutable_explicit_path();
  [[nodiscard]] ::std::string* PROTOBUF_NULLABLE release_explicit_path();
  void set_allocated_explicit_path(::std::string* PROTOBUF_NULLABLE value);

  private:
  const ::std::string& _internal_explicit_path() const;
  PROTOBUF_ALWAYS_INLINE void _internal_set_explicit_path(const ::std::string& value);
  ::std::string* PROTOBUF_NONNULL _internal_mutable_explicit_path();

  public:
  void clear_type();
  TypeCase type_case() const;
  // @@protoc_insertion_point(class_scope:aim.BundleFileLocation)
 private:
  class _Internal;
  void set_has_binary_dir();
  void set_has_user_dir();
  void set_has_explicit_path();
  ...
  struct Impl_ {
    ...
    inline explicit Impl_(
        ::google::protobuf::internal::InternalVisibility visibility,
        ::google::protobuf::Arena* PROTOBUF_NULLABLE arena, const Impl_& from,
        const BundleFileLocation& from_msg);
    union TypeUnion {
      constexpr TypeUnion() : _constinit_{} {}
      ::google::protobuf::internal::ConstantInitialized _constinit_;
      bool binary_dir_;
      bool user_dir_;
      ::google::protobuf::internal::ArenaStringPtr explicit_path_;
    } type_;
    ::google::protobuf::internal::CachedSize _cached_size_;
...
/* @@protoc_insertion_point(class_definition:aim.BundleInfo) */ {
 ...
 public:
  ...
  enum : int {
    ...
    kBundleFileLocationFieldNumber = 2,
  ...
  bool has_bundle_file_location() const;
  void clear_bundle_file_location() ;
  const ::aim::BundleFileLocation& bundle_file_location() const;
  [[nodiscard]] ::aim::BundleFileLocation* PROTOBUF_NULLABLE release_bundle_file_location();
  ::aim::BundleFileLocation* PROTOBUF_NONNULL mutable_bundle_file_location();
  void set_allocated_bundle_file_location(::aim::BundleFileLocation* PROTOBUF_NULLABLE value);
  void unsafe_arena_set_allocated_bundle_file_location(::aim::BundleFileLocation* PROTOBUF_NULLABLE value);
  ::aim::BundleFileLocation* PROTOBUF_NULLABLE unsafe_arena_release_bundle_file_location();

  private:
  const ::aim::BundleFileLocation& _internal_bundle_file_location() const;
  ::aim::BundleFileLocation* PROTOBUF_NONNULL _internal_mutable_bundle_file_location();
 ...
 private:
  ...
  struct Impl_ {
    ...
    ::aim::BundleFileLocation* PROTOBUF_NULLABLE bundle_file_location_;
    bool readonly_;
    bool archived_;
    PROTOBUF_TSAN_DECLARE_MEMBER
  };
...
// repeated .aim.BundleInfo bundles = 17;
inline int Settings::_internal_bundles_size() const {
  return _internal_bundles().size();
}
inline int Settings::bundles_size() const {
  return _internal_bundles_size();
}
inline void Settings::clear_bundles() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.bundles_.Clear();
  ClearHasBitForRepeated(_impl_._has_bits_[0],
                  0x00004000U);
}
inline ::aim::BundleInfo* PROTOBUF_NONNULL Settings::mutable_bundles(int index)
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_mutable:aim.Settings.bundles)
  return _internal_mutable_bundles()->Mutable(index);
}
inline ::google::protobuf::RepeatedPtrField<::aim::BundleInfo>* PROTOBUF_NONNULL Settings::mutable_bundles()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  SetHasBitForRepeated(_impl_._has_bits_[0], 0x00004000U);
  // @@protoc_insertion_point(field_mutable_list:aim.Settings.bundles)
  ::google::protobuf::internal::TSanWrite(&_impl_);
  return _internal_mutable_bundles();
}
inline const ::aim::BundleInfo& Settings::bundles(int index) const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:aim.Settings.bundles)
  return _internal_bundles().Get(index);
}
inline ::aim::BundleInfo* PROTOBUF_NONNULL Settings::add_bundles()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  ::aim::BundleInfo* _add =
  ...
  SetHasBitForRepeated(_impl_._has_bits_[0], 0x00004000U);
  // @@protoc_insertion_point(field_add:aim.Settings.bundles)
  return _add;
}
inline const ::google::protobuf::RepeatedPtrField<::aim::BundleInfo>& Settings::bundles() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_list:aim.Settings.bundles)
  return _internal_bundles();
}
inline const ::google::protobuf::RepeatedPtrField<::aim::BundleInfo>&
Settings::_internal_bundles() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return _impl_.bundles_;
}
inline ::google::protobuf::RepeatedPtrField<::aim::BundleInfo>* PROTOBUF_NONNULL
Settings::_internal_mutable_bundles() {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return &_impl_.bundles_;
}
...
// bool binary_dir = 1;
inline bool BundleFileLocation::has_binary_dir() const {
  return type_case() == kBinaryDir;
}
inline void BundleFileLocation::set_has_binary_dir() {
  _impl_._oneof_case_[0] = kBinaryDir;
}
inline void BundleFileLocation::clear_binary_dir() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  if (type_case() == kBinaryDir) {
    _impl_.type_.binary_dir_ = false;
    clear_has_type();
  }
}
inline bool BundleFileLocation::binary_dir() const {
  // @@protoc_insertion_point(field_get:aim.BundleFileLocation.binary_dir)
  return _internal_binary_dir();
}
inline void BundleFileLocation::set_binary_dir(bool value) {
  if (type_case() != kBinaryDir) {
    clear_type();
    set_has_binary_dir();
  }
  _impl_.type_.binary_dir_ = value;
  // @@protoc_insertion_point(field_set:aim.BundleFileLocation.binary_dir)
}
inline bool BundleFileLocation::_internal_binary_dir() const {
  if (type_case() == kBinaryDir) {
    return _impl_.type_.binary_dir_;
  }
  return false;
}

// bool user_dir = 2;
inline bool BundleFileLocation::has_user_dir() const {
  return type_case() == kUserDir;
}
inline void BundleFileLocation::set_has_user_dir() {
  _impl_._oneof_case_[0] = kUserDir;
}
inline void BundleFileLocation::clear_user_dir() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  if (type_case() == kUserDir) {
    _impl_.type_.user_dir_ = false;
    clear_has_type();
  }
}
inline bool BundleFileLocation::user_dir() const {
  // @@protoc_insertion_point(field_get:aim.BundleFileLocation.user_dir)
  return _internal_user_dir();
}
inline void BundleFileLocation::set_user_dir(bool value) {
  if (type_case() != kUserDir) {
    clear_type();
    set_has_user_dir();
  }
  _impl_.type_.user_dir_ = value;
  // @@protoc_insertion_point(field_set:aim.BundleFileLocation.user_dir)
}
inline bool BundleFileLocation::_internal_user_dir() const {
  if (type_case() == kUserDir) {
    return _impl_.type_.user_dir_;
  }
  return false;
}

// string explicit_path = 3;
inline bool BundleFileLocation::has_explicit_path() const {
  return type_case() == kExplicitPath;
}
inline void BundleFileLocation::set_has_explicit_path() {
  _impl_._oneof_case_[0] = kExplicitPath;
}
inline void BundleFileLocation::clear_explicit_path() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  if (type_case() == kExplicitPath) {
    _impl_.type_.explicit_path_.Destroy();
    clear_has_type();
  }
}
inline const ::std::string& BundleFileLocation::explicit_path() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:aim.BundleFileLocation.explicit_path)
  return _internal_explicit_path();
}
template <typename Arg_, typename... Args_>
PROTOBUF_ALWAYS_INLINE void BundleFileLocation::set_explicit_path(Arg_&& arg, Args_... args) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  if (type_case() != kExplicitPath) {
    clear_type();

    set_has_explicit_path();
    _impl_.type_.explicit_path_.InitDefault();
  }
  _impl_.type_.explicit_path_.Set(static_cast<Arg_&&>(arg), args..., GetArena());
  // @@protoc_insertion_point(field_set:aim.BundleFileLocation.explicit_path)
}
inline ::std::string* PROTOBUF_NONNULL BundleFileLocation::mutable_explicit_path()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  if (type_case() != kExplicitPath) {
    clear_type();
  ...
  ::std::string* _s = _internal_mutable_explicit_path();
  // @@protoc_insertion_point(field_mutable:aim.BundleFileLocation.explicit_path)
  return _s;
}
inline const ::std::string& BundleFileLocation::_internal_explicit_path() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  if (type_case() != kExplicitPath) {
    return ::google::protobuf::internal::GetEmptyStringAlreadyInited();
  }
  return _impl_.type_.explicit_path_.Get();
}
inline void BundleFileLocation::_internal_set_explicit_path(const ::std::string& value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.type_.explicit_path_.Set(value, GetArena());
}
inline ::std::string* PROTOBUF_NONNULL BundleFileLocation::_internal_mutable_explicit_path() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  return _impl_.type_.explicit_path_.Mutable( GetArena());
}
inline ::std::string* PROTOBUF_NULLABLE BundleFileLocation::release_explicit_path() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  // @@protoc_insertion_point(field_release:aim.BundleFileLocation.explicit_path)
  if (type_case() != kExplicitPath) {
    return nullptr;
  }
  clear_has_type();
  return _impl_.type_.explicit_path_.Release();
}
inline void BundleFileLocation::set_allocated_explicit_path(::std::string* PROTOBUF_NULLABLE value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  if (has_type()) {
    clear_type();
  }
  if (value != nullptr) {
    set_has_explicit_path();
    _impl_.type_.explicit_path_.InitAllocated(value, GetArena());
  }
  // @@protoc_insertion_point(field_set_allocated:aim.BundleFileLocation.explicit_path)
}

inline bool BundleFileLocation::has_type() const {
  return type_case() != TYPE_NOT_SET;
}
inline void BundleFileLocation::clear_has_type() {
  _impl_._oneof_case_[0] = TYPE_NOT_SET;
}
inline BundleFileLocation::TypeCase BundleFileLocation::type_case() const {
  return BundleFileLocation::TypeCase(_impl_._oneof_case_[0]);
}
// -------------------------------------------------------------------
...
// .aim.BundleFileLocation bundle_file_location = 2;
inline bool BundleInfo::has_bundle_file_location() const {
  bool value = CheckHasBit(_impl_._has_bits_[0], 0x00000002U);
  PROTOBUF_ASSUME(!value || _impl_.bundle_file_location_ != nullptr);
  return value;
}
inline void BundleInfo::clear_bundle_file_location() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  if (_impl_.bundle_file_location_ != nullptr) _impl_.bundle_file_location_->Clear();
  ClearHasBit(_impl_._has_bits_[0],
                  0x00000002U);
}
inline const ::aim::BundleFileLocation& BundleInfo::_internal_bundle_file_location() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  const ::aim::BundleFileLocation* p = _impl_.bundle_file_location_;
  return p != nullptr ? *p : reinterpret_cast<const ::aim::BundleFileLocation&>(::aim::_BundleFileLocation_default_instance_);
}
inline const ::aim::BundleFileLocation& BundleInfo::bundle_file_location() const ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:aim.BundleInfo.bundle_file_location)
  return _internal_bundle_file_location();
}
inline void BundleInfo::unsafe_arena_set_allocated_bundle_file_location(
    ::aim::BundleFileLocation* PROTOBUF_NULLABLE value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  if (GetArena() == nullptr) {
    delete reinterpret_cast<::google::protobuf::MessageLite*>(_impl_.bundle_file_location_);
  }
  _impl_.bundle_file_location_ = reinterpret_cast<::aim::BundleFileLocation*>(value);
  if (value != nullptr) {
    SetHasBit(_impl_._has_bits_[0], 0x00000002U);
  } else {
    ClearHasBit(_impl_._has_bits_[0], 0x00000002U);
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:aim.BundleInfo.bundle_file_location)
}
inline ::aim::BundleFileLocation* PROTOBUF_NULLABLE BundleInfo::release_bundle_file_location() {
  ::google::protobuf::internal::TSanWrite(&_impl_);

  ClearHasBit(_impl_._has_bits_[0], 0x00000002U);
  ::aim::BundleFileLocation* released = _impl_.bundle_file_location_;
  _impl_.bundle_file_location_ = nullptr;
  if (::google::protobuf::internal::DebugHardenForceCopyInRelease()) {
    auto* old = reinterpret_cast<::google::protobuf::MessageLite*>(released);
    released = ::google::protobuf::internal::DuplicateIfNonNull(released);
    if (GetArena() == nullptr) {
...
inline ::aim::BundleFileLocation* PROTOBUF_NULLABLE BundleInfo::unsafe_arena_release_bundle_file_location() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  // @@protoc_insertion_point(field_release:aim.BundleInfo.bundle_file_location)

  ClearHasBit(_impl_._has_bits_[0], 0x00000002U);
  ::aim::BundleFileLocation* temp = _impl_.bundle_file_location_;
  _impl_.bundle_file_location_ = nullptr;
  return temp;
}
inline ::aim::BundleFileLocation* PROTOBUF_NONNULL BundleInfo::_internal_mutable_bundle_file_location() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  if (_impl_.bundle_file_location_ == nullptr) {
    auto* p = ::google::protobuf::Message::DefaultConstruct<::aim::BundleFileLocation>(GetArena());
    _impl_.bundle_file_location_ = reinterpret_cast<::aim::BundleFileLocation*>(p);
  }
  return _impl_.bundle_file_location_;
}
inline ::aim::BundleFileLocation* PROTOBUF_NONNULL BundleInfo::mutable_bundle_file_location()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  SetHasBit(_impl_._has_bits_[0], 0x00000002U);
  ::aim::BundleFileLocation* _msg = _internal_mutable_bundle_file_location();
  // @@protoc_insertion_point(field_mutable:aim.BundleInfo.bundle_file_location)
  return _msg;
}
inline void BundleInfo::set_allocated_bundle_file_location(::aim::BundleFileLocation* PROTOBUF_NULLABLE value) {
  ::google::protobuf::Arena* message_arena = GetArena();
  ::google::protobuf::internal::TSanWrite(&_impl_);
  if (message_arena == nullptr) {
    delete reinterpret_cast<::google::protobuf::MessageLite*>(_impl_.bundle_file_location_);
  ...
  _impl_.bundle_file_location_ = reinterpret_cast<::aim::BundleFileLocation*>(value);
  // @@protoc_insertion_point(field_set_allocated:aim.BundleInfo.bundle_file_location)
}
